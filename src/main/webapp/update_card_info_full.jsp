...
<div class="space_noborder"></div>
  <button  class="btn btn-success  btn-block" onclick="bindCardFullUpdateSubmit()">提交修改</button><br>
  <button  class="btn btn-danger  btn-block" onclick="cardDelete(2)">删除该卡</button><br>
</div>
