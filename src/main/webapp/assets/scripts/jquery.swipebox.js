		...
		var defaults = {
			...
			html = '<div id="swipebox-overlay">\
					...
					<div id="swipebox-action">\
						<a id="swipebox-close" style="background-image: url(assets/images/gallery/close.png);"></a>\
						<a id="swipebox-prev" style="background-image: url(assets/images/gallery/left.png);"></a>\
						<a id="swipebox-next" style="background-image: url(assets/images/gallery/right.png);"></a>\
					</div>\
			</div>';
