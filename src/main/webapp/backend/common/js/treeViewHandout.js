	...
	jQuery.get(url,function(result){
		...
		if(menulist.length!=0){
			for(var i=0;i<menulist.length;i++){
				...
				if(isTail){
					$("#folderContent"+reid+"").append("<div class='tree-folder child' style='display:block'  id='folder"+menuId+"'><div class='tree-folder-header'><div class='tree-folder-name'>"+menuName+"</div>[<a href='addHandout.jsp?typeid="+menuId+"' target='_blank'>添加讲义资料</a>]</div>");
				}else{
