...
<%@ page language="java" contentType="text/html; charset=UTF-8"
 ...
 <%
	...
	List<Type> types = areaServ.getList(reid);
%>
				...
				<div class="col-sm-6">
					<div class="widget-box">
						<div class="widget-header header-color-blue2">
								<a href="javascript:showOperationPanel(0);" id="id-btn-dialog2" class="btn btn-info"><i class="icon-plus"></i>增加类别</a>
						</div>
							...
							<div class="widget-main padding-8">
								<div class="form-horizontal">
										...
										<div class="form-group">
											...
											<div class="col-sm-9">
												<button class="btn btn-success" onclick="addType()" id="submitButton">提交</button>
											</div>
										</div>
									</div>
								</div>
